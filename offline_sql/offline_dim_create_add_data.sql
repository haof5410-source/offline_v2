...
insert overwrite table dim_coupon_full partition (ds = '20250917')
select id,
       coupon_name,
       coupon_type,
       coupon_dic.dic_name,
...
insert overwrite table dim_activity_full partition (ds = '20250917')
select rule.id,
       info.id,
       activity_name,
       rule.activity_type,
...
insert overwrite table dim_province_full partition (ds = '20250917')
select province.id,
       province.name,
       province.area_code,
       province.iso_code,
...
insert overwrite table dim_promotion_pos_full partition (ds = '20250917')
select `id`,
       `pos_location`,
       `pos_type`,
       `promotion_type`,
...
insert overwrite table dim_promotion_refer_full partition (ds = '20250917')
select `id`,
       `refer_name`,
       `create_time`,
       `operate_time`
